...
description: "This skill should be used when creating documents with Mermaid diagrams, technical reports, architecture docs, or any visualization. Covers 24 diagram types and 9 document templates. Use when user says '画流程图', '画架构图', 'Mermaid图表', '时序图', '甘特图'."
license: Apache-2.0
metadata:
  qwenpaw:
    emoji: "📊"
  skill-source: https://github.com/K-Dense-AI/scientific-agent-skills
  skill-version: "1.0.0"
---
